...
plt.imshow(occupancy_map, cmap='viridis') # optional : cmap='viridis'
plt.axis([0,800,0,800])
scat = plt.scatter(X_bar[:,0]/10, X_bar[:,1]/10, s=5.0, c='r', marker='o') # optional: marker='o'
...
animation.save('../data/temp.gif', dpi=80, writer='imagemagick')
